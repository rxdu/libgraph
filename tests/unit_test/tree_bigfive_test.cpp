...
TEST_F(TreeBigFiveTest, DefaultConstructor)
{
    ...
    ASSERT_EQ(tree.GetTotalVertexNumber(), 6) << "Failed to add vertices to original tree ";
    ASSERT_EQ(tree.GetTotalEdgeNumber(), 6) << "Failed to add edges to original tree ";
}
...
TEST_F(TreeBigFiveTest, CopyConstructor)
{
    ...
    ASSERT_EQ(copy_tree.GetTotalVertexNumber(), 6) << "Failed to add vertices to copied tree ";
    ASSERT_EQ(copy_tree.GetTotalEdgeNumber(), 6) << "Failed to add vertices to copied tree ";

    Tree<TestState> copy_tree2 = copy_tree;

    ASSERT_EQ(copy_tree2.GetTotalVertexNumber(), 6) << "Failed to add vertices to copied tree 2 ";
    ASSERT_EQ(copy_tree2.GetTotalEdgeNumber(), 6) << "Failed to add vertices to copied tree 2 ";
}
...
TEST_F(TreeBigFiveTest, AssignmentOperator)
{
    ...
    ASSERT_EQ(assign_tree.GetTotalVertexNumber(), 6) << "Failed to add vertices to assigned tree ";
    ASSERT_EQ(assign_tree.GetTotalEdgeNumber(), 6) << "Failed to add vertices to assigned tree ";
}
...
TEST_F(TreeBigFiveTest, MoveConstructor)
{
    ...
    ASSERT_EQ(move_tree.GetTotalVertexNumber(), 6) << "Failed to add vertices to moved tree ";
    ASSERT_EQ(move_tree.GetTotalEdgeNumber(), 6) << "Failed to add vertices to moved tree ";
}
...
TEST_F(TreeBigFiveTest, MoveAssignConstructor)
{
    ...
    ASSERT_EQ(move_tree.GetTotalVertexNumber(), 6) << "Failed to add vertices to move assigned tree ";
    ASSERT_EQ(move_tree.GetTotalEdgeNumber(), 6) << "Failed to add vertices to move assigned tree ";
}
